...
struct SnapshotTestSetup : TestChain100Setup {
    ...
    std::tuple<Chainstate*, Chainstate*> SetupSnapshot()
    {
        ...
        size_t initial_size;
        size_t initial_total_coins{COINBASE_MATURITY_LEGACY_COMPAT};
        ...
        // Mine to the regtest assumeutxo height where a valid value can be
        // found. The base TestChain100Setup stays at the historical
        // low-height 100-block compatibility maturity, while regtest
        // assumeutxo data remains at COINBASE_MATURITY + 10.
