...
static constexpr auto MAX_DIGITS_BLC = 16;
...
{
    switch (unit) {
    case Unit::BTC: return QString("BLC");
    case Unit::mBTC: return QString("mBLC");
    case Unit::uBTC: return QString::fromUtf8("µBLC");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Blakecoins");
    case Unit::mBTC: return QString("Milli-Blakecoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Blakecoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("Satoshi (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000 BLC)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
QString BitcoinUnits::format(Unit unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool justify)
{
    ...
    if (justify) {
        quotient_str = quotient_str.rightJustified(MAX_DIGITS_BLC - num_decimals, ' ');
    }
