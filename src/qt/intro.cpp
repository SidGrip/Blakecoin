...
bool Intro::showIfNeeded(bool& did_show_intro, int64_t& prune_MiB)
{
     ...
     * override -datadir in the blakecoin.conf file in the default data directory
...
void Intro::UpdatePruneLabels(bool prune_checked)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Blakecoin block chain.").arg(PACKAGE_NAME) + " " +
