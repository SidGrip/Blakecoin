...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # and matures after COINBASE_MATURITY blocks
        amount_to_send = 1.0
        ...
        if self.options.descriptors:
            ...
            BECH32_INVALID = {
                '❌_VER15_PROG41': 'rblc1sqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqajlxj8',
                '❌_VER16_PROB01': 'rblc1sqq5r4036',
            }
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid Blakecoin address or script",
