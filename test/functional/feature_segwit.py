...
P2WPKH = 0
P2WSH = 1
# Keep enough pre-activation mature coinbase outputs for Blakecoin's ported
# funding-heavy SegWit checks. The original Bitcoin value left this test one
# or more 50-BLC UTXOs short under the Blakecoin regtest maturity/subsidy
...
class SegWitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            self.nodes[0].importprivkey("5JsTwbyY9G6Mynu2m2ZxGTFSy8mwyhgAqfxy2QsNX8J6LgkNfFH")
            uncompressed_spendable_address = ["Bj5igq9TcvpZFRi6yYiZ9GDTtJFLDJdMxE"]
            self.nodes[0].importprivkey("Kwq9BV5nEz4z14B7q7FWGStVCAJXPZkTXitGWbKpoLT7PMNQQqSs")
            compressed_spendable_address = ["BZn9DNWjTSTMAbhHgGZNtdNMzrS4p4Yy9x"]
            ...
            # Import a compressed key and an uncompressed key, generate some multisig addresses
            self.nodes[0].importprivkey("5JMCMMbxYLad1ZHFCqW7RqXpkKSJpG852RGrkUhnJttTfmsFEAZ")
            uncompressed_spendable_address = ["BVB6Lh2wqu6Db1TDT8rQisug54fjoiRGf8"]
            self.nodes[0].importprivkey("KwFs4fackzSJAP9ibDr8RottewSRD6F1ZqfdgMRfY7NEAQNNNFkZ")
            compressed_spendable_address = ["Bok75bS798ugU3gBT4bmYcFXYaXg6EyqP5"]
