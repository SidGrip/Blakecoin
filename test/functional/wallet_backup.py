...
class WalletBackupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # The original Bitcoin test hardcoded 100-block maturity accounting.
        # Blakecoin regtest keeps historical 100-block maturity before the
        # 120-block mainnet restore height, so derive the mature
        # subsidy total from the actual block height.
        expected_total = (self.nodes[3].getblockcount() - COINBASE_MATURITY) * BLOCK_SUBSIDY
