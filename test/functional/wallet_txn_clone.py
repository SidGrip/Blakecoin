...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Node0's balance should be starting balance minus tx1 and tx2 amounts
        # and fees. Each new block advances the initial chain and matures one
        # additional historical 50 BLC coinbase reward.
        ...
        # The reorg advances the chain far enough to mature two historical
        # coinbase rewards. If --mineblock was used above, one reward is
        # already included in expected.
        assert_equal(self.nodes[0].getbalance(), expected + (50 if self.options.mine_block else 100))
