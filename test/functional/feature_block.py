...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Blakecoin's block validation path is slower in this full-weight
        # 1088-block reorg stress section on the release builder, but the node
        # continues accepting blocks. Keep the upstream stress coverage and
        # give it enough wall-clock time to finish.
        self.send_blocks(blocks, True, timeout=3600)
        chain1_tip = i
