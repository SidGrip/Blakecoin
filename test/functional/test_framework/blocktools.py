...
# Genesis block time (Blakecoin regtest)
TIME_GENESIS_BLOCK = 1381036817

MAX_FUTURE_BLOCK_TIME = 2 * 60 * 60

# Coinbase transaction outputs can only be spent after this number of new blocks (network rule)
COINBASE_MATURITY = 100
COINBASE_MATURITY_RESTORED = 120
COINBASE_MATURITY_RESTORE_HEIGHT = 1996240


def coinbase_maturity(spend_height):
    return COINBASE_MATURITY_RESTORED if spend_height >= COINBASE_MATURITY_RESTORE_HEIGHT else COINBASE_MATURITY
