...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def setup(self):
        ...
        fname_bitcoind = preferred_binary_path("blakecoind", "bitcoind")
        fname_bitcoincli = preferred_binary_path("blakecoin-cli", "bitcoin-cli")
        fname_bitcoinutil = preferred_binary_path("blakecoin-util", "bitcoin-util")
    ...
    def _initialize_chain(self):
        ...
        with open(cache_lock, "a+", encoding="utf8") as lockfile:
            ...
            if rebuild_cache:
                ...
                # Set mocktime just beyond Blakecoin regtest's 2*spacing window so
                # the first post-genesis block drops to powLimit difficulty. After
                # that, Blakecoin regtest keeps the easy target while mocktime
        ...
        for i in range(self.num_nodes):
            ...
            initialize_datadir(self.options.tmpdir, i, self.chain, self.disable_autoconnect)  # Overwrite port/rpcport in blakecoin.conf
