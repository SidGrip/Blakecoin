...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Blakecoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def raw_multisig_transaction_legacy_tests(self):
        ...
        self.sync_all()
        self.generate(self.nodes[0], 1)
        assert_equal(self.nodes[0].getbalance(), bal + Decimal('2.19000000'))  # newly mined reward is still immature
