...
complete --command blakecoind --no-files

# Extract options
function __fish_blakecoind_get_options
...
complete \
    --command blakecoind \
    --arguments "(__fish_blakecoind_get_options --nofiles)"
