...
# Extract options
function __fish_blakecoin_tx_get_options
...
# Extract commands
function __fish_blakecoin_tx_get_commands
...
# Add options
complete \
    --command blakecoin-tx \
    --condition "not __fish_blakecoin_seen_cmd (__fish_blakecoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_blakecoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command blakecoin-tx \
    --arguments "(__fish_blakecoin_tx_get_commands)" \
    --no-files
