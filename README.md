...
Build the Blakecoin ([Electrum](https://github.com/BlueDragon747/Blakestream-Electrum)) wallet by
...
Artifacts land in `outputs/Electrum/BLC/`, named `Electrum-BLC-<version>`.
